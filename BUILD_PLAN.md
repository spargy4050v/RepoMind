...
- 8C is user-authorized ahead of the gate: multi-format scheme ingestion, reviewer confirmation, and a traceable deterministic story. It normalizes all sources to the existing raw-record path and seven-feature scorer; it does not verify Module 8.
